...
static inline void qb_hdb_create (
...
static inline int qb_hdb_handle_create (
	struct qb_hdb_handle_database *handle_database,
	int instance_size,
...
static inline int qb_hdb_handle_get (
	struct qb_hdb_handle_database *handle_database,
...
static inline int qb_hdb_handle_get_always (
	struct qb_hdb_handle_database *handle_database,
	qb_hdb_handle_t handle_in,
	void **instance)
{
...
static inline int qb_hdb_handle_put (
	struct qb_hdb_handle_database *handle_database,
	qb_hdb_handle_t handle_in)
{
	unsigned int check = ((unsigned int)(((unsigned long long)handle_in) >> 32));
...
static inline int qb_hdb_handle_destroy (
	struct qb_hdb_handle_database *handle_database,
	qb_hdb_handle_t handle_in)
{
	unsigned int check = ((unsigned int)(((unsigned long long)handle_in) >> 32));
...
static inline int qb_hdb_handle_refcount_get (
	struct qb_hdb_handle_database *handle_database,
	qb_hdb_handle_t handle_in)
{
	unsigned int check = ((unsigned int)(((unsigned long long)handle_in) >> 32));
...
static inline void qb_hdb_iterator_reset (
	struct qb_hdb_handle_database *handle_database)
{
	handle_database->iterator = 0;
}

static inline int qb_hdb_iterator_next (
	struct qb_hdb_handle_database *handle_database,
	void **instance,
